...
export const metadata: Metadata = {
  title: "关于 AgentStore - MCP 插件评级平台",
  description:
    "AgentStore 是 AI Agent 能力的 DNS + 信用评级平台，帮助开发者发现、评估和比较 MCP 插件。",
};
    ...
    <main className="mx-auto max-w-5xl px-6 py-16">
      ...
      <section className="mb-20 text-center">
        ...
        <p className="mb-6 text-xl font-medium text-zinc-300">
          AI Agent 能力的 DNS + 信用评级
        </p>
        <p className="mx-auto max-w-2xl text-base leading-relaxed text-zinc-400">
          帮助开发者发现、评估和比较 MCP 插件。通过 AI 驱动的多维度评分体系和语义搜索，
          让你在数百个插件中快速找到最适合的 Agent 能力。
        </p>
      </section>

      {/* ===== 核心功能 ===== */}
      <section className="mb-20">
        <h2 className="mb-10 text-center text-2xl font-bold">核心功能</h2>
      ...
      {/* ===== 技术架构 ===== */}
      <section className="mb-20">
        <h2 className="mb-10 text-center text-2xl font-bold">技术架构</h2>
        <div className="mx-auto max-w-xl overflow-hidden rounded-xl border border-zinc-800">
          {TECH_STACK.map((item, i) => (
            ...
            >
              <span className="w-14 shrink-0 text-sm font-semibold text-blue-400">
                {item.layer}
              </span>
      ...
      {/* ===== 开源信息 ===== */}
      <section className="mb-20">
        <h2 className="mb-10 text-center text-2xl font-bold">开源</h2>
